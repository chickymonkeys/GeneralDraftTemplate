...
% main title 
\title{Insert a Nice Title here with Title Case\thanks{Acknowledgements. Use footnote for providing further information about author (webpage, alternative address) \emph{and} funding agencies.}}
...
\bibliography{\RefsPath/references}
% \printbibliography
\clearpage
